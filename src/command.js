...
var media_splitter_1 = require("./media-splitter");
commander_1.program
...
(0, media_splitter_1.splitMedia)({
    ...
    outputFileName: function (index, defaultName) {
        return options.name ? "".concat(options.name, "-").concat(index) : "".concat(defaultName, "-").concat(index);
    },
